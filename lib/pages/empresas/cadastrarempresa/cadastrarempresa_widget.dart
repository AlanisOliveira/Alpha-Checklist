...
import 'cadastrarempresa_model.dart';
export 'cadastrarempresa_model.dart';

class CadastrarempresaWidget extends StatefulWidget {
  const CadastrarempresaWidget({super.key});
...
class _CadastrarempresaWidgetState extends State<CadastrarempresaWidget>
  ...
  void initState() {
    ...
    _model.estadoEmpresaTextController ??= TextEditingController();
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: FutureBuilder<List<SelectIdEmpresaRow>>(
              future: SQLiteManager.instance.selectIdEmpresa(),
              builder: (context, snapshot) {
                ...
                final containerSelectIdEmpresaRowList = snapshot.data!;
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .estadoEmpresaTextController,
                                          focusNode:
                                              _model.estadoEmpresaFocusNode,
                                          onChanged: (_) =>
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              FFAppState().addToSetoresCadastro(
                                                  _model
                                                      .descriptionTextController
                                                      .text);
                                              safeSetState(() {});
                                        ...
                                        children: [
                                          Flexible(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .funcoesTextController,
                                                focusNode:
                                                    _model.funcoesFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelStyle:
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: FutureBuilder<List<SelectIdEmpresaRow>>(
                                  future:
                                      SQLiteManager.instance.selectIdEmpresa(),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                    ...
                                    final buttonSelectIdEmpresaRowList =
                                        snapshot.data!;
                                    ...
                                    return FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        await actions.insertSetorFuncao(
                                          _model.nomeEmpresaTextController.text,
                                          _model.cnpjEmpresaTextController.text,
                                          FFAppState().setoresCadastro.toList(),
                                          FFAppState().funcoesCadastro.toList(),
                                          _model
                                              .cidadeEmpresaTextController.text,
                                          _model
                                              .estadoEmpresaTextController.text,
                                        );
