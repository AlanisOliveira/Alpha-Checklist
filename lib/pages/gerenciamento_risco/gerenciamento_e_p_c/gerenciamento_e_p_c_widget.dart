...
import 'gerenciamento_e_p_c_model.dart';
export 'gerenciamento_e_p_c_model.dart';

class GerenciamentoEPCWidget extends StatefulWidget {
  const GerenciamentoEPCWidget({
    super.key,
    this.nome,
  });
  ...
  static String routeName = 'GerenciamentoEPC';
  static String routePath = '/gerenciamentoEPC';

  @override
  State<GerenciamentoEPCWidget> createState() => _GerenciamentoEPCWidgetState();
}

class _GerenciamentoEPCWidgetState extends State<GerenciamentoEPCWidget> {
  late GerenciamentoEPCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GerenciamentoEPCModel());
                      ...
                      children: [
                                          ...
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              padding: MediaQuery.viewInsetsOf(
                                                  context),
                                              child:
                                                  ExplicacaoGerenciamentoEPCWidget(),
                                            ),
                                          );
                                        },
                                      ...
                                      child: FutureBuilder<
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return FlutterFlowDropDown<int>(
                                            controller: _model
                                                    .tipoAgenteValueController1 ??=
                                                FormFieldController<int>(
                                              _model.tipoAgenteValue1 ??= 0,
                                            ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      safeSetState(() {
                                        _model.tipoAgenteValueController1
                                            ?.reset();
                        ...
                        Column(
                          ...
                          children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: FutureBuilder<
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return FlutterFlowDropDown<int>(
                                            controller: _model
                                                    .tipoAgenteValueController2 ??=
                                                FormFieldController<int>(
                                              _model.tipoAgenteValue2 ??= 0,
                                            ),
                                            options: List<int>.from(
                                                tipoAgenteTiposdeRiscosListRowList
                                                    .map((e) => e.id)
                                  ...
                                  if (_model.isEditing == true)
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        safeSetState(() {});
                                        await SQLiteManager.instance.updateEpcs(
                                          nome: FFAppState().updateEPC,
                                          id: FFAppState().idEPC.toString(),
                                        );
                                      },
                                      child: Icon(
                                        Icons.check_rounded,
                            ...
                            FutureBuilder<List<SelectEPCfromIDRow>>(
                              future: SQLiteManager.instance.selectEPCfromID(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnSelectEPCfromIDRowList =
                                    snapshot.data!;
                                ...
                                return SingleChildScrollView(
                                  ...
                                  child: Column(
                                    ...
                                    children: List.generate(
                                        columnSelectEPCfromIDRowList.length,
                                        (columnIndex) {
                                      final columnSelectEPCfromIDRow =
                                          columnSelectEPCfromIDRowList[
                                              columnIndex];
                                      return Padding(
                                        padding: EdgeInsets.all(15.0),
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                if (_model.isEditing == true)
                                                  Expanded(
                                                    child: UpdateEPCWidget(
                                                      key: Key(
                                                          'Keycpq_${columnIndex}_of_${columnSelectEPCfromIDRowList.length}'),
                                                      nomeAgente:
                                                          columnSelectEPCfromIDRow
                                                              .nome!,
                                                      index: columnIndex,
                                                      id: columnSelectEPCfromIDRow
                                                          .id!,
                                                    ),
                                                  ),
                                                Row(
