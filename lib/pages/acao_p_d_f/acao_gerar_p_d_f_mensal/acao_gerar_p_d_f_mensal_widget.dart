...
import 'acao_gerar_p_d_f_mensal_model.dart';
export 'acao_gerar_p_d_f_mensal_model.dart';

class AcaoGerarPDFMensalWidget extends StatefulWidget {
  const AcaoGerarPDFMensalWidget({
    super.key,
    bool? cancel,
    bool? delete,
  ...
  @override
  State<AcaoGerarPDFMensalWidget> createState() =>
      _AcaoGerarPDFMensalWidgetState();
}

class _AcaoGerarPDFMensalWidgetState extends State<AcaoGerarPDFMensalWidget> {
  late AcaoGerarPDFMensalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcaoGerarPDFMensalModel());
  }
