...
import '/pages/acao_p_d_f/acao_gerar_p_d_f_risco/acao_gerar_p_d_f_risco_widget.dart';
...
import 'z_assinatura_component_model.dart';
export 'z_assinatura_component_model.dart';

class ZAssinaturaComponentWidget extends StatefulWidget {
  const ZAssinaturaComponentWidget({super.key});

  @override
  State<ZAssinaturaComponentWidget> createState() =>
      _ZAssinaturaComponentWidgetState();
}

class _ZAssinaturaComponentWidgetState
    extends State<ZAssinaturaComponentWidget> {
  late ZAssinaturaComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZAssinaturaComponentModel());
  }
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: listAssinaturas.length,
                                  itemBuilder: (context, listAssinaturasIndex) {
