...
import 'adicionarimagem_model.dart';
export 'adicionarimagem_model.dart';
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 8.0),
                                            child: Text(
                                              'Faça upload das suas imagens aqui',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
                                ...
                                builder: (context) {
                                  ...
                                  return SingleChildScrollView(
                                    ...
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children:
                                          List.generate(imagensLista.length,
                                              (imagensListaIndex) {
                                        final imagensListaItem =
                                            imagensLista[imagensListaIndex];
                                        return Container(
                                          width: 250.0,
                                          height: 300.0,
                                          decoration: BoxDecoration(),
                                          child: Container(
                                            width: 250.0,
                                            height: 250.0,
                                            child: custom_widgets.HtmlImage(
                                              width: 250.0,
                                              height: 250.0,
                                              base64Image: imagensListaItem,
                                              borde: 5.0,
                                              index: imagensListaIndex,
                                            ),
                                          ),
                                        );
                                      }),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          FFAppState().descricaoImagem = _model
